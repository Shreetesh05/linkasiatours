          ...
          <motion.button
            ...
            className={`px-6 py-3 rounded-full font-medium transition-all ${
              selectedDestination === 'all'
                ...
                : 'bg-white/90 backdrop-blur-sm text-gray-700 shadow-md hover:bg-white'
            }`}
          ...
          <motion.button
            ...
            className={`px-6 py-3 rounded-full font-medium transition-all ${
              selectedDestination === 'india'
                ? 'bg-gradient-to-r from-purple-500 to-indigo-600 text-white shadow-lg shadow-purple-400/30'
                : 'bg-white/90 backdrop-blur-sm text-gray-700 shadow-md hover:bg-white'
            }`}
            onClick={() => setSelectedDestination('india')}
          >
            India Pilgrimages
          </motion.button>
        </motion.div>
